...
USERCMD UserCmds[] =
{
	...
	{ L"/setinfo",		PlayerInfo::UserCmd_SetInfo, L"Usage: /setinfo <self|paragraphNr> <a/d> <text>"},
	{ L"/showinfo",		PlayerInfo::UserCmd_ShowInfoSelf, L"Usage: /showinfo"},
	{ L"/si",			PlayerInfo::UserCmd_SetInfo, L"Usage: /setinfo <self|paragraphNr> <a/d> <text>" },
...
pub::AI::SetPersonalityParams HkMakePersonality() {
	...
	p.state_graph = pub::StateGraph::get_state_graph("FIGHTER", pub::StateGraph::TYPE_LEADER);
	p.state_id = true;
