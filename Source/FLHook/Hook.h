...
EXPORT void HkAddAdminCmdLog(const string&, const string&, uint clientId);
...
extern FARPROC ShipColGrpDmgFunc, SolarColGrpDmgFunc, SolarShieldDamageOrigFunc, ShipEquipDamageOrigFunc, SolarEquipDamageOrigFunc;
